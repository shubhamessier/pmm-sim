...
Swaps 150,000 USDC to WSOL using Humidifi and SolfiV2 - split evenly - 75000 USDC per Prop AMM
...
```
cargo r -- multi --pmms="[[humidifi,solfi-v2],[humidifi]]" --weights "[[99, 1],[100]]" --amount-in=100,3
```
